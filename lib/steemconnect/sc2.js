...
const sc2 = {
  baseURL: 'https://api.steemlogin.com',
  app: '',
  callbackURL: '',
  scope: [],
};
...
sc2.AUTHURL = () => `${sc2.baseURL}/oauth2/authorize?client_id=${sc2.app}&redirect_uri=${encodeURIComponent(sc2.callbackURL)}&response_type=code&scope=comment,vote,comment_options,offline`;
